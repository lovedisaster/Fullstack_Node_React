...
import actions from '../../../client/actions/propertyActions';
import {PropertiesList} from '../../../client/components/list/PropertiesList';

describe('< />', () => {
  it('renders one <PropertiesList /> components', () => {
    const props = {
        actions: actions,
        properties : [{
        "price": "$726,500",
    ...
    const wrapper = shallow(<PropertiesList {...props}/>);
  });
});
